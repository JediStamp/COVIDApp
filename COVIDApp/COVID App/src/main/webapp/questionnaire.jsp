...
<body>
	...
	<table class="questionTable" >
			...
			<tr><!-- Q1 -->
				...
				<td><input type="radio" name="select1" value="Yes"></td>
				<td><input type="radio" name="select1" value="No"></td>
			</tr>
			
			<tr><!-- Q2 -->
				<td>In the last 10 days, have you been identified as a close contact<br/>
					of someone who currently has COVID-19?</td>
				<td><input type="radio" name="select2" value="Yes"></td>
				<td><input type="radio" name="select2" value="No"></td>
			</tr>
			
			<tr><!-- Q3 -->
				<td>In the last 10 days, have you received a COVID Alert exposure <br/>
					notification on your cell phone?</td>
				<td><input type="radio" name="select3" value="Yes"></td>
				<td><input type="radio" name="select3" value="No"></td>
			</tr>
			
			<tr><!-- Q4 -->
				<td>In the last 14 days, have you travelled outside of Canada?</td>
				<td><input type="radio" name="select4" value="Yes"></td> 
				<td><input type="radio" name="select4" value="No"></td>
			</tr>
			...
			<tr><!-- Q5 -->
				...
				<td><input type="radio" name="select5" value="Yes"></td> 
				<td><input type="radio" name="select5" value="No"></td>
			</tr>
			...
			<tr><!-- Q6 -->
				...
				<td><input type="radio" name="select6" value="Yes"></td> 
				<td><input type="radio" name="select6" value="No"></td>
			</tr>
			...
			<tr><!-- Q7 -->
				...
				<td><input type="radio" name="select7" value="Yes"></td>
				<td><input type="radio" name="select7" value="no"></td>
			</tr>
			...
			<tr><!-- Q8 -->
				...
				<td><input type="radio" name="select8" value="Yes"></td> 
				<td><input type="radio" name="select8" value="No"></td>
			</tr>
			...
			<tr><!-- Q9 -->
				...
				<td><input type="radio" name="select9" value="Yes"></td> 
				<td><input type="radio" name="select9" value="No"></td>
			</tr>
			...
			<tr>
				...
				<td><input type="radio" name="select10" value="Yes"></td> 
				<td><input type="radio" name="select10" value="No"></td>
			</tr>
